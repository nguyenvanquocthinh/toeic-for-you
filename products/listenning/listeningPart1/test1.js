...
const app = {
  ...
  songs: [
    {
      name: "Test 1.1",
      path: "../../../assets/css/img/test1_toeic/part1/test1.1_mixdown.mp3",
      translation: "Một người phụ nữ đang đứng cạnh chiếc bạn.",
      pronunciation: "A woman is standing near a desk.",
    },
    {
      name: "Test 1.2",
      path: "../../../assets/css/img/test1_toeic/part1/test1.2_mixdown.mp3",
      translation: "Một người phụ nữ đang đi lên những bậc thang.",
      pronunciation: "A woman is climbing some stairs.",
    },
    {
      name: "Test 1.3",
      path: "../../../assets/css/img/test1_toeic/part1/test1.3_part1_mixdown.mp3",
      translation: "Một người phụ nữ đang bước vào toà nhà.",
      pronunciation: "A woman is entering a building.",
    },
    {
      name: "Test 1.4",
      path: "../../../assets/css/img/test1_toeic/part1/test1.4_part1_mixdown.mp3",
      translation: "Một người phụ nữ đang nhìn vào tấm bản đồ.",
      pronunciation: "A woman is looking at a map.",
    },
    {
      name: "Test 1.5",
      path: "../../../assets/css/img/test1_toeic/part1/test1.5_part1_mixdown.mp3",
      translation: "Cô ấy đang bơi trên sông.",
      pronunciation: " She’s swimming in the water.",
    },
    {
      name: "Test 1.6",
      path: "../../../assets/css/img/test1_toeic/part1/test1.6_part1_mixdown.mp3",
      translation: "Cô ấy đang đi bộ cạnh đại dương.",
      pronunciation: "She’s jogging near the ocean.",
    },
    {
      name: "Test 1.7",
      path: "../../../assets/css/img/test1_toeic/part1/test1.7_part1_mixdown.mp3",
      translation: "Những chiếc ghế được xếp bên bờ biển.",
      pronunciation: "Chairs are set up on the beach.",
    },
    {
      name: "Test 1.8",
      path: "../../../assets/css/img/test1_toeic/part1/test1.8_part1_mixdown.mp3",
      translation: "Chiếc mũ đang nằm trên cát.",
      pronunciation: "A hat is lying on the sand.",
    },
    {
      name: "Test 1.9",
