  ...
  songs: [
    {
      ...
      translation: "Tòa nhà này bao nhiêu tuổi?",
      pronunciation: "How old is this building?",
    },
    {
      name: "Test 1.2",
      path: "../../../assets/css/img/part2_test1_toeic/1.2.mp3",
      translation: "Để vận chuyển một số vật liệu.",
      pronunciation: "YTo ship some materials.",
    },
    {
      name: "Test 1.3",
      path: "../../../assets/css/img/part2_test1_toeic/1.3.mp3",
      translation: "Khoảng mười tuổi. ",
      pronunciation: "About ten years old.",
    },
    {
      name: "Test 1.4",
      path: "../../../assets/css/img/part2_test1_toeic/1.4.mp3",
      translation: "Văn phòng công ty, tôi nghĩ vậy.",
      pronunciation: "Company offices, I think.",
    },
    {
      name: "Test 1.5",
      path: "../../../assets/css/img/part2_test1_toeic/1.5.mp3",
      translation:
        "Bạn có thể đến buổi biểu diễn nhạc jazz của tôi tối nay được không?",
      pronunciation: "Can you come to my jazz performance tonight?",
    },
    {
      name: "Test 1.6",
      path: "../../../assets/css/img/part2_test1_toeic/1.6.mp3",
      translation: "Tôi xin lỗi vì đã đến cuộc họp trễ.",
      pronunciation: "’m sorry I was late for the meeting.",
    },
    {
      name: "Test 1.7",
      path: "../../../assets/css/img/part2_test1_toeic/1.7.mp3",
      translation: "Hầu hết chỉ là các nhạc sĩ địa phương.",
      pronunciation: "Mostly just local musicians. ",
    },
    {
      name: "Test 1.8",
      path: "../../../assets/css/img/part2_test1_toeic/1.8.mp3",
      translation: "Chắc chắn rồi, tôi sẽ ở đó!",
      pronunciation: "Sure, I'll be there!",
    },
    {
      name: "Test 1.9",
      path: "../../../assets/css/img/part2_test1_toeic/1.9.mp3",
      translation: "Căn hộ nào nộp giấy phép xây dựng vậy?",
      pronunciation: "Which apartment submitted a work order?",
    },
    {
      name: "Test 1.10",
      path: "../../../assets/css/img/part2_test1_toeic/1.10.mp3",
      translation: "Đó là những gì bạn đã làm để kiếm sống.",
      pronunciation: "It’s what you did for a living.",
    },
    {
      name: "Test 1.11",
      path: "../../../assets/css/img/part2_test1_toeic/1.11.mp3",
      translation: " Gửi bài tập của bạn ở đây.",
      pronunciation: "Submit your assignment here.",
    },
    {
      name: "Test 1.12",
      path: "../../../assets/css/img/part2_test1_toeic/1.12.mp3",
      translation: "Nó đến từ những người thuê ở B23.",
      pronunciation: "It came from the tenants in B23.",
    },
    {
      name: "Test 1.13",
